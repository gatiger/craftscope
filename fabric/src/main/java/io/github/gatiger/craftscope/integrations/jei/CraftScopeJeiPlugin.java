...
public class CraftScopeJeiPlugin
    ...
    private boolean openRecipe(
        ...
        /*
         * First try CraftScope's process ID directly as a JEI
         * recipe-type ID.
         *
         * Vanilla IDs such as minecraft:smelting and
         * minecraft:blasting follow this path.
         */
        ...
        /*
         * Fallback for mod integrations.
         *
         * A future CraftScope provider may use a process ID that
         * is not identical to the JEI category ID. In that case
         * scan JEI's registered categories for the exact recipe
         * IDs.
         *
         * This only happens when the user clicks View Recipe, so
         * it does not add continuous overhead.
         */
    ...
    /*
     * JEI's ingredient list is displayed only while Recipe Tree
     * is active.
     *
     * Process Diagram can still explicitly open JEI's recipe
     * screen through CraftScopeRecipeViewer.
     */
